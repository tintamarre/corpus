  ...
  <div>
    ...
    <div class="row">
      <div class="col-lg-9 col-md-12 col-sm-12">
        ...
        <text-labels
        :text="text"
        :labels="text.relationships.labels"
        />

        <text-tagscloud
        :tagscloud="text.relationships.tagscloud" />
      ...
      <div class="col-lg-3 col-md-12 col-sm-12">
        ...
        <div class="card-text">
          <text-stats
          :stats="text.relationships.stats" />
        </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-2 col-md-2 col-lg-2">
        <h5 class="text-right text-muted">{{ __('app.text').toUpperCase() }}</h5>
...
<div class="row" v-if="(text.relationships.segments.length == 0)">
  ...
  <div class="form-group" v-if="add_new">
    ...
    <div class="alert alert-primary" role="alert" v-html="__('app.info_how_to_segment_text')">
...
export default {
  ...
  mounted() {
    ...
    window.addEventListener('scroll', () => {       this.getScrollPercentage(this.progressStartMarker, this.progressEndMarker)
    });
  },
