  ...
  <div class="">
    <div class="row">
      ...
      <div class="col-sm-7 col-md-7 col-lg-7">
        ...
        <p
          class="card-text text-content"
          :id="'segment-div-' + segment.id"
      ...
      <div class="col-sm-2 col-md-2 col-lg-2">
        <div
          v-for="(tag, index) in segment.tags"
          :key="tag.snippet.segment_tag_id"
          :style="
            positionSnippet(tag.snippet.snippet_start, tag.snippet.snippet_end)
          "
        >
          <div class="btn-group">
            <button
              ...
              aria-expanded="false"
              @mouseover="
                wrapSnippet(tag.snippet.snippet_start, tag.snippet.snippet_end)
              "
      ...
      <div class="col-sm-2 col-md-2 col-lg-2">
        <div class="small">
          <!-- <button
            ...
            v-tooltip:top="
              __('app.edit') + ' ' + __('app.segment') + ' ' + __('app.above')
            "
          >
            <fa icon="edit"></fa>
          </button> -->
          ...
          <button
            ...
            class="btn btn-link btn-sm"
            v-tooltip:top="
              __('app.delete') + ' ' + __('app.segment') + ' ' + __('app.above')
            "
          >
            <fa icon="trash"></fa>
          </button>
...
export default {
  ...
  computed: {
    wrapContent() {
      return (
        this.segment.content.substring(0, this.snippet_start) +
  ...
  methods: {
    ...
    selectSnippet(e) {
      ...
      if (snippet_end - snippet_start > 0 && snippet_end > 1) {
